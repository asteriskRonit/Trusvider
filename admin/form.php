...
$des="";
///echo $id;
$query="select * from servicetable where sid='$id'";
$quer="select * from servicetable where sid='$id'";
...
if(isset($_POST["add"])){
    ...
    $sn=$_POST["dp"];
    $sp=$_POST["ser"];
    $quer="update servicetable set servicepart='$dp',servicename='$sn',price='$sp' where sid='$id'";
...
<body>
    <div class="container mt-2">
      <form class="border p-4 bg-white rounded w-100" method="post" action=" ">
        <h2 class="mb-3 fw-bold">Edit services</h2>
        <div class="mb-3">
          <label for="txt1" class="form-label">DEVICE PART</label>
          <input type="text" name="dt" class="form-control" id="txt1"  placeholder="ram,cpu" value=<?php echo $dp; ?> readonly>
        </div>
        <div class="mb-3">
